...
def network_data():
    ...
    nx_vertice = pd.read_csv(str(config["node_file"]), usecols=['node', 'lng', 'lat'])
    ...
    # nx_edge = pd.read_csv(str(config["edge_file"]),
    ...
    # if dataset == 'beijing':
    #     edge_dist['length'] = edge_dist['length'] / 100.0
    ...
    return nx_vertice, 1, vertice_dict, 1, edge_dist, edge_dist_dict, roadnetwork
